      ...
      <div className={classes.About}>
        ...
        <div className={classes.About__text}>
          <p>
            ...
            their hard work and attention to detail, our company&apos;s
            reputation improves and we&apos;re able to help more clients realize
            their visions.
        ...
        <section className={classes.About}>
          ...
          <div className={classes.About__paragraph}>
            <p>
              ...
              I&apos;m provided the opportunities to be creative and use
              critical thinking. Following several years working on my own, I
              realized that I could use my experience and my education best by
              opening a company that provided both consulting and development
              services to clients.
            </p>
          </div>
        </section>
