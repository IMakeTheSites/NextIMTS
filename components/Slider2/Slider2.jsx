...
const Slider2 = () => {
  return (
    <div className={classes.Slider2}>
      <h1 className={classes.Slider2__heading}>
        Independent
      ...
      <div className={classes.Slider2__callUs}>
        <p className={classes.Slider2__callUs__text}>
          Contact Us Today for FREE Consultations
        </p>
        <button className={classes.Slider2__callUs__button}>
          Call +1 4356 2666
        </button>
      </div>
    </div>
