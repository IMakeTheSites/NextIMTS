            ...
            <div className={classes.Footer__list}>
                ...
                <div className={classes.Footer__list__icons}>
                    ...
                    <div className={classes.Footer__list__icons__list}>
                      <a href="https://www.facebook.com/imakethesites" target="_blank">  <svg className={classes.Footer__list__icons__list__icon} viewBox="0 0 8 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                       ...
                       <a href="https://www.linkedin.com/company/i-make-the-sites/" target="_blank"> <svg className={classes.Footer__list__icons__list__icon} viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
